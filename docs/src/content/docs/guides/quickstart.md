---
title: Quickstart
description: Install nimlet, set an API key, and run your first turn.
---
...
- Keeping the REPL with `-i` / `--interactive`
- Clean stdout with `-p` / `--print`
- Piped stdin: `cat README.md | ./nimlet -p "Summarize this text"`
- Where to go next
